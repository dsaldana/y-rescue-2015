...
The recruiter sends \msg{engage} messages to selected teammates and \msg{release} to non-selected ones.  Note that \msg{engage} messages used in the recruitment protocol are different from \msg{engaging} messages used in general communication (previously described). This recruitment process is a simplification of the recruitment protocol of eXtreme-Ants algorithm \cite{Santos&Bazzan2009optmas}. Figure \ref{fig:auction} illustrates the recruitment process.
